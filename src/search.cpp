...
void Thread::tsearch() {
    ...
    for (int depth = 1; depth <= maxDepth; depth++) {
        ...
        while (true) {
            ...
            value = search<ROOT_NODE>(&rootBoard, stack, depth, alpha, beta);
            // std::cout << "depth: " << depth << " alpha: " << alpha << " beta: " << beta << " delta: " << delta << " value: " << value << std::endl;
            ...
            // We found a checkmate. This shouldn't count as a fail high
